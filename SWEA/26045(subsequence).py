...
1. 리스트 두 개를 차례대로 입력받음
2. 리스트 a와 b를 각각 순회하면서 순서대로 리스트 b의 요소가 a에도 들어있는지 확인하기
3. 들어있다면 인덱스 번호 +1을 하면서 리스트 b와 리스트 a를 순회
4. 만약 리스트 b의 인덱스 j의 값이 리스트 a에 없다면 거기에서 stop
